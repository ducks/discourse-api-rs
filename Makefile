...
help:
	@echo "discourse-api-rs Makefile"
	@echo ""
	@echo "Usage:"
	...
	@echo "  make build                         - Build WASM package"
	@echo "  make test                          - Run tests"
	@echo "  make clean                         - Clean build artifacts"
	@echo ""
	@echo "Examples:"
	@echo "  make version-bump 20251117.0.0     - Creates branch and bumps version"
	@echo "  make release 20251117.0.0          - Full release (merge, tag, push)"
	@echo ""
	@echo "Note: VERSION prefix is optional:"
	@echo "  make release 20251117.0.0          - Creates tag v20251117.0.0"
	@echo "  make release v20251117.0.0         - Creates tag v20251117.0.0 (same)"
...
release: version-bump
	...
	@echo "✓ GitHub Actions will build and publish WASM package"
